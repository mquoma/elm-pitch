...
var author$project$Main$ProcessAudio = function (a) {
	return {$: 'ProcessAudio', a: a};
};
var elm$json$Json$Decode$string = _Json_decodeString;
var author$project$Main$audio = _Platform_incomingPort('audio', elm$json$Json$Decode$string);
var elm$core$Platform$Sub$batch = _Platform_batch;
var author$project$Main$subscriptions = function (model) {
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				author$project$Main$audio(author$project$Main$ProcessAudio)
			]));
};
